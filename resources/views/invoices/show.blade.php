                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-primary">{{ $invoice->section->name }}</td>
                                                        </tr>
                                        ...
                                        <div class="tab-pane" id="tab5">
                                            <div class="table-responsive mt-15">
                                                <table class="table center-aligned-table mb-0 table-hover"
                                                    ...
                                                    <tbody>
                                                        @foreach ($invoice->Invoice_Details as $i=>$x)
                                                            <tr>
                                                                <td>{{ $i+1 }}</td>
                                                ...
                                                <div class="table-responsive mt-15">
                                                    <table class="table center-aligned-table mb-0 table table-hover"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($invoice->Invoice_attachments as $i=>$attachment)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        ...
                                                                        <a class="btn btn-outline-success btn-sm"
                                                                            href="{{ url('viewFile') }}/{{ $attachment->invoice_number }}/{{ $attachment->file_name }}"
                                                                            role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                            عرض</a>

                                                                        <a class="btn btn-outline-info btn-sm"
                                                                            href="{{ url('downloadFile') }}/{{ $attachment->invoice_number }}/{{ $attachment->file_name }}"
                                                                            role="button"><i
