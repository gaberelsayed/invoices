...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">            
            ...
            @can('الاقسام')
                <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'sections')) }}"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                        <path
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة') 
                            <li><a class="slide-item" href="{{ url('get_invoices/1') }}">الفواتير المدفوعة</a>

                        @endcan 

                        </li>
                        @can('الفواتير الغير مدفوعة') 
                            <li><a class="slide-item" href="{{ url('get_invoices/2') }}">الفواتير
                                    الغيرمدفوعة</a>
                            </li>
                        @endcan 

                        @can('الفواتير المدفوعة') 
                        <li><a class="slide-item" href="{{ url('get_invoices/3') }}">الفواتير المدفوعة
                                    جزئيا</a>
                            </li>
            ...
            @can('المستخدمين')
                ...
                <li class="slide">
                    ...
                    <svg
                        ...
                        <span class="side-menu__label">تسجيل خروج</span></a>
                </li>
            </ul>
    </div>
</aside>
